...
class ChatMessage(BaseModel):
    ...
    # Tool-calling round-trip: tool result messages carry the call id, and
    # assistant messages may carry tool_calls (which we ignore for prompting —
    # the emulated protocol reads them from the flattened text instead).
...
class ChatCompletionRequest(BaseModel):
    ...
    thinking: bool = False
    search: bool = False
    # Tool calling (emulated): standard OpenAI tools array + tool_choice.
